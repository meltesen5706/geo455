...
// Proportional circles - attribute name is 'number_of1'

function getRadius(area) {
  var radius = Math.sqrt(area/Math.PI);
  return radius * 2; // adjust this value based on data //
}
...
var heat = L.heatLayer(heatMapPoints, {
    radius: 25, // Can change this value
    minOpacity: 0.5,
...
var searchControl = new L.Control.Search({
    position:'topright',
    layer: peaks,
    propertyName: 'TITLE', // Attribute value
    marker: false,
    markeranimate: true,
    delayType: 50, // Can change this value
    collapsed: false,
...
var overlayMaps = {
    ...
    "<img src='js/propcircles.png' height=16> Expeditions Proportional Circles": propcircles,
    "<img src='js/dead.jpg' height=16> Death Density Heat Map": heat,
